...
LEVEL_ACHIEVEMENTS = {
    5: {'title': 'Велком ту зе клаб бади', 'description': 'Выдается за достижение 5 уровня'},
    10: {'title': 'Ёмаё а ты хорош ', 'description': 'Выдается за достижение 10 уровня'},
    20: {'title': 'Эээ дорогой, поумерь свой пыл', 'description': 'Выдается за достижение 20 уровня'},
    30: {'title': 'Это же сколько ты там сидишь?', 'description': 'Выдается за достижение 30 уровня'},
    50: {'title': 'Иди займись уже чем-нибудь полезным', 'description': 'Выдается за достижение 50 уровня'},
}